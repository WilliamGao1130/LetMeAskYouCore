...
class ChatEngineTest {
    ...
    private static class AddTool implements org.bluepowerrobotics.lmau.core.toolcall.Tool {
        @Override
    ...
    void toolLoopFeedsResultsBackAndReturnsFinalAnswer() {
        ...
        org.bluepowerrobotics.lmau.core.toolcall.ToolsManager tools =
                new org.bluepowerrobotics.lmau.core.toolcall.ToolsManager(new AddTool());
